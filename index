        ...
        <div class="content-area">
            ...
            <div class="left-panel">
                <div class="profile-section">
                    <div class="profile-avatar" src='image/avatar.jpg>I</div>
        ...
        <div class="gallery-container">
            <div class="gallery-slides" id="gallerySlides">
                ...
                <div class="gallery-slide placeholder">
                    ...
                    <div>
                        <div class="caption-title">Mountain Adventure</div>
                        <div class="caption-description">Hiking in the Rocky Mountains</div>
                    </div>
                </div>
                ...
                <div class="gallery-slide placeholder">
                    <div class="placeholder-icon">🏖️</div>
                    <div>
                        <div class="caption-title">Beach Vacation</div>
                        <div class="caption-description">Relaxing by the ocean</div>
                    </div>
                </div>
                ...
                <div class="gallery-slide placeholder">
                    ...
                    <div>
                        <div class="caption-title">Music Hobby</div>
                        <div class="caption-description">Playing guitar in my free time</div>
                    </div>
                </div>
                ...
                <div class="gallery-slide placeholder">
                    <div class="placeholder-icon">🍳</div>
                    <div>
                        <div class="caption-title">Cooking Passion</div>
                        <div class="caption-description">Experimenting with new recipes</div>
                    </div>
                </div>
                ...
                <div class="gallery-slide placeholder">
                    <div class="placeholder-icon">📚</div>
                    <div>
                        <div class="caption-title">Learning & Growth</div>
                        <div class="caption-description">Always expanding my knowledge</div>
                    </div>
                </div>
            </div>
            
            <button class="gallery-controls gallery-prev" onclick="changeSlide(-1)">❮</button>
            <button class="gallery-controls gallery-next" onclick="changeSlide(1)">❯</button>
        </div>
        
        <div class="gallery-indicators" id="galleryIndicators">
            <div class="gallery-indicator active" onclick="currentSlide(1)"></div>
            <div class="gallery-indicator" onclick="currentSlide(2)"></div>
            <div class="gallery-indicator" onclick="currentSlide(3)"></div>
            <div class="gallery-indicator" onclick="currentSlide(4)"></div>
            <div class="gallery-indicator" onclick="currentSlide(5)"></div>
        </div>
        
        <div class="gallery-info">
            <div class="gallery-counter">
                <span id="currentSlideNum">1</span> of <span id="totalSlides">5</span>
            </div>
            <div class="gallery-actions">
                <button class="gallery-action-btn" onclick="openFullscreen()">Fullscreen</button>
                <button class="gallery-action-btn" onclick="autoPlay()">Auto Play</button>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        const photos = [
            ...
            },
            {
                ...
                alt: 'Lego',
                title: 'Lego',
                description: 'Photo of one of my hobbies'
            }
        ];
        ...
        function openFullscreen() {
            ...
            // For placeholder slides, we'll show a message
            if (photos[currentSlideIndex]) {
                modalImage.src = photos[currentSlideIndex].src;
                modalImage.alt = photos[currentSlideIndex].alt;
            } else {
                modalImage.src = 'data:image/svg+xml;base64,';
        ...
        document.getElementById('gallerySlides').addEventListener('touchstart', function(e) {
            touchStartX = e.changedTouches[0].screenX;
        });
        
        document.getElementById('gallerySlides').addEventListener('touchend', function(e) {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Optional: Load actual images if they exist
            loadActualImages();
        });
                    ...
                    img.onload = function() {
                        ...
                        slides[index].innerHTML = `
                            ...
                            <div class="gallery-caption">
                                ...
                                <div class="caption-description">${photo.description}</div>
                            </div>
                        `;
                        slides[index].classList.remove('placeholder');
                    };
